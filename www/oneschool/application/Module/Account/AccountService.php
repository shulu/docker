...
use app\module\account\model\UserVip;
...
class AccountService
{
	...
	public function __construct()
	{
		...
		$this->countingStorage = Cache(['type'  =>  'redis', 'host'	=>	'192.168.99.100', 'port' => 6379,'expire'=>  14400, 'prefix'=>  'user_counting:']);
		#$this->profileStorage = Cache(['type'  =>  'redis', 'host'	=>	'127.0.01', 'port' => 6379,'expire'=>  14400, 'prefix'=>  'user_profile:']);
		$this->profileStorage = Cache(['type'  =>  'redis', 'host'	=>	'192.168.99.100', 'port' => 6379,'expire'=>  14400, 'prefix'=>  'user_profile:']);
...
//            $a = $this->storage->get($user->id);
	...
	public function fetchCountings($ids) {
		return $this->countingStorage->handler()->getMultiple($ids);
	}
	...
	{
		/** @var UserVip[] $infos */
		$infos = UserVip::where(['user_id' => $userIds])->find();
		$result = [];
		if ($infos):
