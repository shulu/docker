...
class ShortVideoPostSynthesizer extends AbstractSynthesizer {
    /**
     * @var Synthesizer
     */
    ...
    public function __construct(
        ...
        $imGroupSynthesizer, $scheduleSynthesizer, $votingSynthesizer
    ) {
    ...
    public function declareOnlyLive($isOnlyLive=true) {
    ...
    protected function synthesize($post, $info = null) {
        if ($post->deleted&&$this->isOnlyLive) {
            return null;
        }
        if ($post->deleted) {
            return array(
