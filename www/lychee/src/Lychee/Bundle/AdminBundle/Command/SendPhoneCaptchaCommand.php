...
class SendPhoneCaptchaCommand extends ContainerAwareCommand
{
    /**
     *
     */
    protected function configure() {
        $this->setName('lychee-admin:phone-captcha:send')
    ...
    private function getPhoneVerifier() {
        return $this->getContainer()->get('lychee.module.authentication.phone_verifier');
    }
