  ...
  $.fn[pluginName] = function(options) {
    ...
    var pagination = {
      ...
      createTemplate: function(args) {
        ...
        var html = '';
        var goInput = '<input type="text" class="-go-pagenumber">';
        var goButton = '<input type="button" class="-go-button" value="' + goButtonText + '">';
        var formattedString;
        var i;
        ...
        if (showNavigator) {
          if (formatNavigator) {
            ...
            html += '<div class="' + classPrefix + '-nav -nav">' + formattedString + '<\/div>';
          }
        }
      ...
      observer: function() {
        ...
        // Previous click
        el.delegate('.-previous', 'click', function(event) {
          var current = $(event.currentTarget);
          var pageNumber = $.trim(current.attr('data-num'));
        ...
        // Next click
        el.delegate('.-next', 'click', function(event) {
          var current = $(event.currentTarget);
          var pageNumber = $.trim(current.attr('data-num'));
        ...
        // Go button click
        el.delegate('.-go-button', 'click', function() {
          var pageNumber = $('.-go-pagenumber', el).val();
        ...
        // go input enter
        el.delegate('.-go-pagenumber', 'keyup', function(event) {
          if (event.which === 13) {
